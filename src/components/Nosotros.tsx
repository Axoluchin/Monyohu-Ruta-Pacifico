...
const Nosotros = () => {
  return (
    <article className="grid grid-cols-2 gap-12 align-top justify-start my-12">
      <Card className="align-top justify-start">
        <div className="h-full">
          <h2 className="text-3xl font-bold text-center">Nosotros</h2>
          ...
          <ul className="grid grid-cols-2 list-disc ml-10 gap-3 mt-8">
      ...
      <Card>
        ...
        <ul className="grid grid-cols-2 list-disc mx-20 text-lg">
          <li>Lavadoras</li>
          <li>Microondas</li>
          <li>Hornos</li>
          <li>Secadoras</li>
